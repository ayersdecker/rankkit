    ...
    <div className="social-media-tools-container">
      <nav className="dashboard-nav">
        ...
        <div id="mobile-navigation" className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
          ...
          <button onClick={() => handleNavClick('/social-media-tools')} className="nav-link active">Social</button>
      ...
      <div className="social-media-tools-content">
        ...
        {!isAuthed && (
          <div className="guest-cta">
            <div>
              <h3>Explore the social media toolkit</h3>
              <p>See what is available. Sign in to optimize posts and save outputs.</p>
            </div>
